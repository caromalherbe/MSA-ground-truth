...
for k = 1:n_groundT
        ...
        for h = 1:n_pat
            ...
            if (data_binary(h,first)== 1 && data_binary(h,second) == 1) || (data_binary(h,first)== 0 && data_binary(h,second) == 0)   %try with double lesions
                scorebin(h,k) = 1;
            end
...
maxerror = 0.01; %da decidere sull base del p
...
save('LC_doublesourcegradedmutualinhibMAPP.mat')
